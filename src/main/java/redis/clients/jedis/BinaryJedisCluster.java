...
public class BinaryJedisCluster extends JedisCluster {
    ...
    public BinaryJedisCluster(Set<HostAndPort> nodes,GenericObjectPoolConfig genericObjectPoolConfig) {
        super(nodes,genericObjectPoolConfig);
    }
    public BinaryJedisCluster(Set<HostAndPort> nodes, int timeout,GenericObjectPoolConfig genericObjectPoolConfig) {
        super(nodes,timeout,genericObjectPoolConfig);
    }
